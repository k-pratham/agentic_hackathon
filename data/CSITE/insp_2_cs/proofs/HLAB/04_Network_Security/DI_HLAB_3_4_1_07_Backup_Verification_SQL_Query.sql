-- ===================================================
-- Bank: Himgiri Local Area Bank Limited
-- Observation: 3.4.1
-- Purpose: SQL query for backup status verification across databases
...
PRINT '========================================';
PRINT '  Himgiri Local Area Bank Limited - Audit Query';
PRINT '  Observation: 3.4.1';
...
ELSE
    PRINT '[FAIL] Audit control procedures missing - 3.4.1';
